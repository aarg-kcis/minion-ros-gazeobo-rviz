...
PurePursuit::PurePursuit(int selfID) : selfID_(selfID), ld_(1.0), v_max_(0.1), v_(v_max_), w_max_(1.0), pos_tol_(0.1), idx_(0),
                             goal_reached_(true), nh_private_("~"), tf_listener_(tf_buffer_),
                             map_frame_id_("world"), robot_frame_id_("base_link"),
                             lookahead_frame_id_("lookahead")
{
  ...
  nh_private_.param<double>("position_tolerance", pos_tol_, 1.2);
  ...
  nh_private_.param<string>("robot_frame_id", robot_frame_id_, "minion_"+boost::lexical_cast<string>(selfID_)+"_ground_truth");
  ...
  sub_path_ = nh_.subscribe("minion_"+boost::lexical_cast<string>(selfID_)+"/path_segment", 1, &PurePursuit::receivePath, this);
  sub_odom_ = nh_.subscribe("minion_"+boost::lexical_cast<string>(selfID_)+"/ground_truth_pose", 1, &PurePursuit::computeVelocities, this);
  pub_vel_ = nh_.advertise<geometry_msgs::Twist>("minion_"+boost::lexical_cast<string>(selfID_)+"/diff_drive_controller/cmd_vel", 1);
...
int main(int argc, char**argv)
{
  ...
  PurePursuit controller(atoi(argv[1]));
  controller.run();
