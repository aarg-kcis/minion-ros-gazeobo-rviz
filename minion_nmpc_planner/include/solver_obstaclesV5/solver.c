...
double eval_objv(void) {
  ...
  objv += work.quad_977932222464[0]+work.quad_177068883968[0]+work.quad_68309282816[0]+work.quad_607940841472[0]+work.quad_453715046400[0]+work.quad_291936759808[0]+work.quad_236996321280[0];
  return objv;
}
