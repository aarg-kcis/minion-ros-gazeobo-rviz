...
Eigen::Matrix<double, 9, 11> MPCsolver::OCPsolDesigner(double deltaT, Eigen::Matrix<double, 3, 11> obstacle_force, Eigen::Vector3d ExternalForce, Eigen::Matrix<double, 6, 1> curState, Eigen::Matrix<double, 6, 1> termState, Eigen::Matrix<double, 9, 1> CostFunction, Eigen::Matrix<double, 6, 2> stateLimits, Eigen::Matrix<double, 3, 2> input_constraint)
{

    // initialize 1st predictive state and control input
    Eigen::Matrix<double, 9, 11> StateInput = Eigen::Matrix<double, 9, 11>::Zero();
...
void MPCsolver::load_data(double deltaT, Eigen::Matrix<double, 3, 11> obstacle_force, Eigen::Vector3d ExternalForce, Eigen::Matrix<double, 6, 1> InitialState, Eigen::Matrix<double, 6, 1> TerminalState, Eigen::Matrix<double, 6, 2> StateConstraint, Eigen::Matrix<double, 3, 2> InputConstraint, Eigen::Matrix<double, 9, 1> CostFunction)
{  
    for(int i=0; i<2; i++)
...
Eigen::Matrix<double, 9, 11> MPCsolver::use_solution(Vars vars)
{
  Eigen::Matrix<double, 9, 11> StateInput_output = Eigen::Matrix<double, 9, 11>::Zero();   
