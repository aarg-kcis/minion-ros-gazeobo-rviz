...
void load_default_data(void) {
  ...
  params.f_min[0] = 0.17437730638329096;
  params.f_min[1] = -1.6408365219077408;
  params.f_min[2] = -0.04450702153554875;
  params.f_max[0] = 1.7117453902485025;
  params.f_max[1] = 1.1504727980139053;
  params.f_max[2] = -0.05962309578364744;
}
